...
var cloneEvent = _f6Core.Util.cloneEvent,
  isViewportChanged = _f6Core.Util.isViewportChanged;
var EventController = /** @class */function (_super) {
  ...
  EventController.prototype.initEvents = function () {
    ...
    this.canvasHandler = (0, _util.wrapBehavior)(this, 'onCanvasEvents');
