...
var _gMobile = require("@antv/g-mobile");
...
var registerGraph = function registerGraph(graphName, GraphFunction, G6) {
  if (G6[graphName]) {
...
var Graph = /** @class */function (_super) {
  ...
  Graph.prototype.initCanvas = function () {
    ...
    var canvas = new _gMobile.Canvas(canvasCfg);
  ...
  Graph.prototype.toFullDataURL = function (callback, type, imageConfig) {
    ...
    var vCanvas = new _gMobile.Canvas(canvasOptions);
  ...
  Graph.prototype.setTextWaterMarker = function (texts, config) {
    ...
    if (!canvas) {
      ...
      canvas = new _gMobile.Canvas(canvasCfg);
  ...
  Graph.prototype.initGroups = function () {
    ...
    var waterGroup = canvas.addGroup({
      id: 'water',
      className: _global.default.waterContainerClassName
    });
    ...
    var uiGroup = canvas.addGroup({
      id: 'uiGroup',
      className: _global.default.uiContainerClassName
    });
