...
var _chunkRHHAW4W3cjs = require('./chunk-RHHAW4W3.cjs');
...
function nuxt_default(options = {}, nuxt) {
  ...
  nuxtApp.hook("webpack:config", (configs) => {
    configs.forEach((config) => {
      ...
      config.plugins.unshift(_chunkRHHAW4W3cjs.src_default.webpack(options));
    });
  });
  nuxtApp.hook("vite:extend", async (vite) => {
    vite.config.plugins = vite.config.plugins || [];
    vite.config.plugins.push(_chunkRHHAW4W3cjs.src_default.vite(options));
  });
}
