...
export const pageSizeArr = [gbLimit * 1, gbLimit * 2, gbLimit * 3]
...
export function getDayMore() {
  return localStorage.getItem(DayMore)
}
export function setDayMore(more: string) {
  return localStorage.setItem(DayMore, more)
}
