...
import { throwError } from '@nm/element-plus/es/utils'
import { useNamespace } from '@nm/element-plus/es/hooks'
import { BAR_MAP, renderThumbStyle } from '@nm/element-plus/es/components/scrollbar/src/util'
import { thumbProps } from '@nm/element-plus/es/components/scrollbar/src/thumb'
